...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME ||'HEO', //'hexo', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mudrobøt', // 您的昵称 例如 tangly1024
